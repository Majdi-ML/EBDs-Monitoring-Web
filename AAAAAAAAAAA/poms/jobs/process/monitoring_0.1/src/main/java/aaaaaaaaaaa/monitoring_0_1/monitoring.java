...
package aaaaaaaaaaa.monitoring_0_1;
...
public class monitoring implements TalendJob {
	...
	public static class insertclustersStruct implements routines.system.IPersistableRow<insertclustersStruct> {
		final static byte[] commonByteArrayLock_AAAAAAAAAAA_monitoring = new byte[0];
		static byte[] commonByteArray_AAAAAAAAAAA_monitoring = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_AAAAAAAAAAA_monitoring.length) {
					if (length < 1024 && commonByteArray_AAAAAAAAAAA_monitoring.length == 0) {
						commonByteArray_AAAAAAAAAAA_monitoring = new byte[1024];
					} else {
						commonByteArray_AAAAAAAAAAA_monitoring = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_AAAAAAAAAAA_monitoring, 0, length);
				strReturn = new String(commonByteArray_AAAAAAAAAAA_monitoring, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_AAAAAAAAAAA_monitoring, 0, length);
				strReturn = new String(commonByteArray_AAAAAAAAAAA_monitoring, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_AAAAAAAAAAA_monitoring) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:R2ypEshPgxQKbypLA7b+yxaj7LAzYNEESuGy4w==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:QgoFXSf6CoaWs8XLAmEEuBT6SrHg0co647FeIw==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_10 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:+PW6As5fR+uoN4UA43KBkbh29TSOnu4A7Eq1IQ==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_13 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:NhtqBOJYQcbRlEACLT7pkY21i/1ZJN1qS8oVDg==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_15 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:Ma46wJAMDbtiybU+NpshRpgeRxx0stgbJX+fZQ==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_18 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:pvR2hzQsRaabvYmAd1a3fKp1G4h6GbLpXDYFdA==");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
					...
					final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:IpswC5+9nn0y0kYEbDZhL+VNy/K8XNqNh6cu4A==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_6 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:8rH+DUjb/5InWaI1EPNEZSy0jnOVIpw18oGP4A==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_21 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:iK1brk/EenH8DrMorUxx7T4o62BZfqzkvv6wIg==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_24 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:CpCLRYet5uuT7UWYohaQ+Hfat2hbdUTSMVCt4g==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:VCSmYm8LGGGX5PRMd74TUcMhf/FSyHLmVqWgFA==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_48 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:4dmHqAAZEFinU45fzkB+LNu34FQ5kfR+YotqsA==");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_3 = 0; i_tFileList_3 < list_tFileList_3.size(); i_tFileList_3++) {
					...
					final String decryptedPassword_tDBOutput_36 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:1NKm1pBfhYGRrcLlCnc/Qrz/8WWAdM1aZUpVOg==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_39 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:sgT2e37AGNiyCRaOJlGgn919JamL7je4NuMo1g==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_28 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:qfOoNSiHKMklEbLA4m+2Be5V7vaGTz+S6ol28Q==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_31 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:YUQDojOve3opJOe2nZlcjB1b8Fy42nbJqtaYXw==");
...
// ###############################      
					...
					final String decryptedPassword_tDBOutput_6 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:KT6+T4FNeePcPf2znWAAgVEBOAMxTSf9QkZIvg==");
...
// ###############################
					...
					final String decryptedPassword_tFileInputExcel_3 = routines.system.PasswordEncryptUtil
							.decryptPassword("enc:routine.encryption.key.v1:oU4KAu2FG/hZJH+OFiX8aX7P3JgvczZEAF0hYg==");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = monitoring.class.getClassLoader()
					.getResourceAsStream("aaaaaaaaaaa/monitoring_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 899753 characters generated by Talend Open Studio for Data Integration on the
 * 31 juillet 2023 à 9:58:39 AM WAT
 ************************************************************************************************/